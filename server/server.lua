...
AddEventHandler('onResourceStart', function(resourceName)
    ...
    local d = LoadResourceFile(GetCurrentResourceName(), "config/client_config.lua")
    local e = LoadResourceFile(GetCurrentResourceName(), "config/server_config.lua")
    local f = LoadResourceFile(GetCurrentResourceName(), "config/server_webhooks.lua")
    if not d or d == "" then
        print("^"..math.random(1, 9).."[Lightshield | System]:^1 Server Configuration Missing, Please make sure you installed LightShield correctly. ^0")
...
print[[^5
 ...
 /_____/_/\__, /_/ /_/\__/____/_/ /_/_/\___/_/\__,_/   
      ...
      Wait(2000)
      print("^"..math.random(1, 9).."^5[^5Lightshield | ^7System]: ^5Loaded ^7Client Config ^5Sucessfully")
      Wait(2500)
      print("^"..math.random(1, 9).."^5[^5Lightshield | ^7System]: ^5Loaded ^7Server Config ^5Sucessfully")
      Wait(1000)
      banlistregenerator()
      Wait(2500)
      print("^"..math.random(1, 9).."^5[^5Lightshield | ^7System]: ^5Loaded ^7Webhooks Config ^5Sucessfully")
      Wait(math.random(800, 1400))
      if Lightshield_Server.AntiCiper then
            print("^5[^5Lightshield | ^7System]: ^1Anti Cipher is enabled, we are checking for backdoors!^0")
